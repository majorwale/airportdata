                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="invoice-title">
                                    <h2>Receipt</h2>
                                    <div class="invoice-number">Order ID #{{ $transaction->order->uuid }}</div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-md">
                                        ...
                                        <tr>
                                            ...
                                            <td>Delivery from {{ $transaction->order->pickupRegion }} to
                                                {{ $transaction->order->deliveryRegion }}</td>
                    ...
                    <div class="text-md-right">
                        <div class="float-lg-left mb-lg-0 mb-3">
                            {{-- <button class="btn btn-primary btn-icon icon-left"><i
                                ...
                                Payment</button> --}}
                            <button class="btn btn-danger btn-icon icon-left"><i class="fas fa-times"
                                    onclick="history.back();"></i> Cancel</button>
                        </div>
