        ...
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                    <h4 class="page-title m-b-0">Open Sharing Request</h4>
                </li>
            </ul>
            @can('isSuperAdmin')
                @if (count($shares) > 0)
                                                ...
                                                <tbody>
                                                    @foreach ($shares as $key => $share)
                                                        <tr>
                                                            ...
                                                            <td>{{ $key + 1 }}</td>
                                                            <td>{{ $share->labA->fullname }}</td>
                                                            <td>{{ $share->labB->fullname }}</td>
                                                            <td>{{ $share->samples }}</td>
                                                            <td>{{ $share->rider->fullname }}</td>
                                                            <td>
                                                                @switch($share->status)
                                                                    @case('Pending')
                                                            ...
                                                            <td>{{ $share->created_at->format('F j, Y') }}</td>
                                                            <td><a href="/share-details/{{ $share->uuid }}"
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="table-2">
                                                ...
                                                <tbody>
                                                    @foreach ($allShares as $key => $share)
                                                        <tr>
                                                            <td class="text-center pt-2">
                                                                <div class="custom-checkbox custom-control">
                                                                    <input type="checkbox" data-checkboxes="mygroup"
