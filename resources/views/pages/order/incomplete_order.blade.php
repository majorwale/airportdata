        ...
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                    <h4 class="page-title m-b-0">Unassigned Orders</h4>
                </li>
            </ul>
                                            ...
                                            <tbody>
                                                @foreach ($incompleteOrders as $key => $incompleteOrder)
                                                    <tr>
                                                        ...
                                                        {{-- <td>{{ $key + 1 }}</td> --}}
                                                        <td>{{ $incompleteOrder->pickupRegion }}</td>
                                                        <td>{{ $incompleteOrder->deliveryRegion }}</td>
                                                        <td>{{ $incompleteOrder->user->fullname }}</td>
                                                        <td>{{ $incompleteOrder->lab->fullname }}</td>
                                                        <td>{{ $incompleteOrder->created_at->format('F j, Y') }}</td>
                                                        <td><a href="/order-details/{{ $incompleteOrder->uuid }}"
