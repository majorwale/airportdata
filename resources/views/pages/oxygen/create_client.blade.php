        ...
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                    <h4 class="page-title m-b-0">Register Oxygen Client</h4>
                </li>
            </ul>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/oxygen/client/create" id="wizard_with_validation">
                                    @csrf
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <!-- <div class="form-group form-float col-md-6">
                                                <div class="form-line">
                                                    <label class="form-label" for="pricePerUnit">Price Per Unit (m3) <span
                                                            class="text-danger">*</span></label>
