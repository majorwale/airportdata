                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" novalidate="" action="/register-supervisor"
                                    method="POST">
                                    @csrf
                                    @include('partials.user.messages')
                                    <div class="form-group">
                                        <label for="fullname">Full Name</label>
                                        <input id="fullname" type="text" class="form-control @error('fullname') is-invalid @enderror" name="fullname" tabindex="1" required
                                            autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cpassword" type="password" class="form-control @error('cpassword') is-invalid @enderror" name="cpassword" tabindex="2" required>
                                        <div class="invalid-feedback">
