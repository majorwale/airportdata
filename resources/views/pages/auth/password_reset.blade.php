                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="/auth-password-reset/{{ $user->id }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password" class="form-control pwstrength @error('pwindicator') is-invalid @enderror" data-indicator="pwindicator"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password-confirm" type="password" class="form-control @error('password-confirm') is-invalid @enderror" name="cpassword"
                                            tabindex="2" required>
                                    </div>
                                    <div class="form-group">
